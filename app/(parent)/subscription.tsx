...
export default function SubscriptionPage() {
  ...
  useEffect(() => {
    const fetchSub = async () => {
      const userId = getUserIdSafe(session?.user?.id);
      if (!userId) {
      ...
      const cleaned = {
        ...data,
        sub_plan: data.sub_plan?.trim() || 'basic',
      };
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {subInfo ? (
          <View style={styles.card}>
            ...
            <Text style={styles.detail}>Current Plan: {subInfo.sub_plan}</Text>
            ...
            <View style={styles.featuresSection}>
              {PLAN_FEATURES[subInfo.sub_plan]?.map((feature, idx) => (
